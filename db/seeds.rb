...
puts 'creating vaults'
  vault_1 = Vault.create(donation_amount: 12500, current_amount_vault:550, name: "Housing", description: "Our housing vault distributes donations to help people pay for household expenses, such as rent, utility bills and unexpected costs")
  vault_2 = Vault.create(donation_amount: 14500, current_amount_vault:725, name: "Medical", description: "Our Medical vault collects and distributes donations to help people pay for unexpected medical expenses.")
  vault_3 = Vault.create(donation_amount: 12250, current_amount_vault:1610, name: "Education", description: "Our Education vault collects and distributes donations to help pay for education expenses, such as school fees, books and pens.")
